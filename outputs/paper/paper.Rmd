...
abstract: Gun violence is a very serious problem in the modern world so statistics about shooting occurrences are an important factor to consider. This paper analyzed yearly data about shooting occurrences that were reported in Toronto in different geographic divisions of the city from 2014 to 2019. The analysis showed that there was a  mostly increasing trend in shooting occurrences in Toronto from 2014 to 2019 and a close correlation between current year and the number of shooting occurrences in the year. The findings in this paper have serious implications for the crime rate and the effectiveness of gun control in Toronto.
