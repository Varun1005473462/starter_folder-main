...
Table 3 (Table \@ref(tab:dataskim)) shows the summary statistics such as mean, minimum, maximum and median for shooting_occurrences.


```{r dataskim, echo =FALSE}
shooting_occurrences_year$Shooting_count %>%
  datasummary_skim(title ="Table 3: summary statistics for shooting_occurrences") 
```



Table 4 (Table \@ref(tab:datacorrelation) )shows the correlation between year and shooting occurrences reported in that year. 


```{r datacorrelation, echo=FALSE}
shooting_occurrences_year %>%
  datasummary_correlation(title = "Table 4: correlation between year and shooting occurrences reported in that year") 
```
